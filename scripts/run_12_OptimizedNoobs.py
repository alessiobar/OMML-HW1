...
start = time.time()
params, train_errors, y, num_grad, num_eval = fit(X_train, Y_train, N = 30, sigma = 1.2, r = 0.01, learning_rate = 0.01, number_of_iterations = 2000)
with open ('weights12.pkl', 'wb') as f:
